function RadarChart(id, data, options) {
    var cfg = {
        ...
        opacityCircles: 0.08,     //The opacity of the circles of each blob
        opacityRadarArea: 0.7,
        strokeWidth: 2,         //The width of the stroke around each blob
        roundStrokes: true,    //If true the area and stroke will follow a round path (cardinal-closed)
        charts_secondary_color: "#cccccc",
        text_color: "#cdcdcd",
    ...
    axisGrid.selectAll(".levels")
       ...
       .enter()
        ...
        .style("fill", cfg.charts_secondary_color)//function(d) {return cfg.color}) 
    ...
    blobWrapper
        ...
        .style("fill-opacity", cfg.opacityRadarArea)
